...
- Standardised date format (British → American)
...
**3. Data Visualisation/ Dashboard Build**
...
- **Los Angeles/CA and Baltimore/MD carry the bulk of the volume.** LA/CA handles 13,734 calls and Baltimore/MD 11,012 - together well over 70% of total volume - while Chicago/IL (5,419) and Denver/CO (2,776) handle far less. Any staffing or resourcing conversation needs to account for this imbalance.
...
- **Call-centre is the leading channel but not by a wide margin.** Call-centre handles 32.3% of volume (10,639 calls), followed by Chatbot (25.1%, 8,256), Email (22.7%, 7,470), and Web (20.0%, 6,576) - a fairly even split rather than one channel dominating.
